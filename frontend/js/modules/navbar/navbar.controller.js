...
(function(){
    ...
    SidebarController.$inject = ['$scope', '$state', '$rootScope', 'EventService', 'AuthService', 'usSpinnerService', '$sessionStorage'];

    /**
     * @namespace SidebarController
     * @desc Controller for handling specific sidebar functions
     ...
     * @constructor
     */
    function SidebarController($scope, $state, $rootScope, EventService, AuthService, usSpinnerService, $sessionStorage){
        var vm = this;
